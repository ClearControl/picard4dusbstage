...
int __stdcall piGetMotorStatus(int * ReportedPosition, BOOL* Moving, BOOL* AtHome, void * devicePtr);
...
int __stdcall piGetTwisterStatus(int * ReportedPosition, BOOL* Moving, void * devicePtr);
int __stdcall piGetTwisterSensorPosition(int* SensorPosition, void* devicePtr);
int __stdcall piGetTwisterStatusEx(int* ReportedPosition, int* SensorPosition, BOOL* Moving, void * devicePtr);
...
int __stdcall piSetGWheelPosition(int Position, void * devicePtr);
